...
`python3 scripts/verify_all.py $ARGUMENTS`

Example (Phase 4 section gate):

`python3 scripts/verify_all.py drafts/05_results.md drafts/table_1.md --results results --evidence knowledge/evidence.md --gate review/gates\phase_04_draft.GATE.md --artifact drafts/05_results.md --require-check constraint --require-check citation --require-check numbers --require-check logic --verify-hash artifact=drafts/05_results.md --verify-hash results=results/table2_outcomes.csv`
